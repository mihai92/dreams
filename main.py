...
def train_dataset(number_of_epochs):
...
# Training the model
    valid_acc_max = 0.0
    trained_model, accuracy_stats, loss_stats = train(number_of_epochs, valid_acc_max, model, optimizer, criterion, scheduler, train_loader, val_loader, "./logs/current_checkpoint.pt", "./logs/best_model.pt", start_epoch=1)
